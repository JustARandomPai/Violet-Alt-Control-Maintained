...
if not (Players.LocalPlayer.Name == controller["MainAccount"]) then
    ...
    if connections then
        for _, v in pairs(connections(Players.LocalPlayer.Idled)) do
            if v.Disable then
                v:Disable()
...
for i, botName in ipairs(bots) do
    if Players.LocalPlayer.Name == botName and config["SendJoinMsg"] == true then
...
if not (Players.LocalPlayer.Name == controller["MainAccount"]) then
    Players:FindFirstChild(controller["MainAccount"]).Chatted:Connect(
        function(msg)
            ...
            if msg == "$dance4" then
                ...
                k:AdjustSpeed(1)
                Players.LocalPlayer.Character.Animate.Disabled = true
                Players.LocalPlayer.Character.Humanoid.Running:connect(
                    function(speed)
                        if speed > 0 then
                            Players.LocalPlayer.Character.Animate.Disabled = false
                            k:Stop(0)
            ...
            if msg:sub(1, 6) == "$wall " then
                ...
                getgenv().LoopLook,
                getgenv().LoopFollow,
                getgenv().LoopStack = false, false, false, false, false, false
                local player =
                    Players:GetPlayers()[
                        (function()
                            for i, plr in ipairs(Players:GetPlayers()) do
                                if
                                    string.lower(plr.Name):sub(1, string.len(msg:sub(7))) == string.lower(msg:sub(7)) or
                                    string.lower(plr.DisplayName):sub(1, string.len(msg:sub(7))) == string.lower(msg:sub(7))
                                then
                                    return i
                                end
                            end
                ...
                if player then
                    ...
                    for i, botName in pairs(bots) do
                        if string.lower(botName) == string.lower(Players.LocalPlayer.Name) then
                            botIndex = i
                            break
                        end
                    end
                    ...
                    elseif table.find(bots, player.Name) then
                        ...
                        while getgenv().LoopWall do
                            Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
                                Players[player.Name].Character.HumanoidRootPart.CFrame *
                    ...
                    Players:GetPlayers()[
                        (function()
                            for i, plr in ipairs(Players:GetPlayers()) do
                                if
                                    string.lower(plr.Name):sub(1, string.len(msg:sub(7))) == string.lower(msg:sub(7)) or
                                    string.lower(plr.DisplayName):sub(1, string.len(msg:sub(7))) ==
                                    string.lower(msg:sub(7))
                                then
                                    return i
                                end
                            end
                        ...
                        (function()
                            for i, plr in ipairs(Players:GetPlayers()) do
                                if
                                    ...
                                    string.lower(plr.DisplayName):sub(1, string.len(msg:sub(8))) ==
                                    string.lower(msg:sub(8)) or
                                    string.lower(plr.Name):sub(1, string.len(msg:sub(8))) ==
                                    string.lower(msg:sub(8)) .. " " or
                                    string.lower(plr.DisplayName):sub(1, string.len(msg:sub(8))) ==
                                    string.lower(msg:sub(8)) .. " "
                                then
                                    return i
                                end
                            end
                ...
                local player =
                    Players:GetPlayers()[
                        (function()
                            for i, plr in ipairs(Players:GetPlayers()) do
                                if
                                    string.lower(plr.Name):sub(1, string.len(msg:sub(9))) == string.lower(msg:sub(9)) or
                                    string.lower(plr.DisplayName):sub(1, string.len(msg:sub(9))) ==
                                    string.lower(msg:sub(9))
                                then
                                    return i
                                end
                            end
                        ...
                        while getgenv().LoopLook do
                            Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
                                CFrame.lookAt(
                                    ...
                                    Players[player.Name].Character.HumanoidRootPart.Position
                                )
                            task.wait()
                        end
                    end
            ...
            if msg:sub(1, 8) == "$follow " then
                ...
                local function followPlayer(playerName)
                    for _, player in ipairs(Players:GetPlayers()) do
                        if
                            string.lower(player.Name):sub(1, #playerName) == string.lower(playerName) or
                            string.lower(player.DisplayName):sub(1, #playerName) == string.lower(playerName)
                        then
                            if player == Players.LocalPlayer then
                                chatmsg("The user you specified is one of your bots!")
                            elseif table.find(bots, player.Name) then
                                ...
                                if humanoidRootPart then
                                    ...
                                    while getgenv().LoopFollow do
                                        if
                                            (LocalPlayer.Character.HumanoidRootPart.Position - humanoidRootPart.Position).Magnitude >
                                            3
                                        then
            ...
            if msg:sub(1, 7) == "$stack " then
                ...
                if player then
                    ...
                    elseif table.find(bots, player.Name) then
                        ...
                        PartForBot = Instance.new("Part", Workspace)
                        PartForBot.Name = "NewPartInstance"
                        PartForBot.CFrame = Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame
                        PartForBot.Transparency = 1
                        getgenv().LoopStack = true
                        local currentPlayer = player
                        while getgenv().LoopStack and currentPlayer == player do
                            Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
                                Players[player.Name].Character:WaitForChild("HumanoidRootPart").CFrame *
                                CFrame.new(0, offset, 0)
                            game:GetService("Workspace").NewPartInstance.CFrame =
                                Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame *
                                CFrame.new(0, -3.6, 0)
                            task.wait()
                            currentPlayer = Players:GetPlayerByUserId(player.UserId)
                        end
            ...
            if msg == "$playercount" then
                if Players.LocalPlayer.Name == bots[1] then
                    ...
                    local playerAmount = #Players:GetPlayers() - botAmount
                    chatmsg(
                        "There are " ..
                        #Players:GetPlayers() ..
                        " players currently in the server including " ..
                        botAmount ..
                        " bot(s), " .. playerAmount .. " players without the bot(s) being included!"
                    )
                elseif Players.LocalPlayer.Name ~= bots[1] then
                --
                end
